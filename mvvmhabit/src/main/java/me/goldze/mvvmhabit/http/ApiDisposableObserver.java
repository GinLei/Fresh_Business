    ...
    public void onNext(Object o) {
        ...
        switch (baseResponse.getErrno()) {
            ...
            case CodeRule.CODE_300:
                //请求失败，不打印Message
                KLog.e("请求失败");
                ToastUtils.showShort("错误代码:", baseResponse.getErrno());
                break;
            ...
            case CodeRule.CODE_502:
                ...
                KLog.e("没有数据");
                break;
            case CodeRule.CODE_205:
                KLog.e("用戶信息未完善");
                break;
            case CodeRule.CODE_510:
                //无效的Token，提示跳入登录页
                ToastUtils.showShort("token已过期请重新登录");
                //关闭所有页面
